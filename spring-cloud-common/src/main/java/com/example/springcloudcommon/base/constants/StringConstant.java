...
public final class StringConstant {
	...
	//附件存放路径
	public static String LAYEDIT_PATH;//存放地址
	public static String UPLOAD_FILE_URL;
	public static String NGINX_PATH;//nginx路径
	...
	//捷顺
	public static final String CID = "880075500000001";//客户号
	public static final String USR = "880075500000001";//账号
	public static final String PSW = "888888";         //密码
	public static final String VERSION   = "2";        //版本
	public static final String SIGN_KEY = "7ac3e2ee1075bf4bb6b816c1e80126c0";       //签名
	public static final String PARK_CODE = "0010028888";                            //停车场编号
	public static final String LOGIN_URL = "http://syx.jslife.com.cn/jsaims/login"; //登陆url
	public static final String BUSINESS_URL = "http://syx.jslife.com.cn/jsaims/as"; //业务url
	public static final String FILE_URL = "http://cloud.jslife.cn:port/uploadMedia"; //文件上传统一url
