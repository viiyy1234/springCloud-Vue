...
public class RequestResponseUtil {
	 ...
	 * @throws Exception
	 */
	public static void putResponseStr(HttpSession session, HttpServletResponse response, HttpServletRequest request, ModelMap modelMap, String success) {
		try {
			request.setCharacterEncoding("utf-8");
			response.setCharacterEncoding("UTF-8");
			response.setContentType("text/html;charset=utf-8");
			...
			map.put("message", modelMap.get("message")==null?"":modelMap.get("message"));
	 ...
	 * @throws Exception
	 */
	public static void putResponseStr(HttpSession session, HttpServletResponse response, HttpServletRequest request, String message, String success) {
		try {
			request.setCharacterEncoding("utf-8");
			response.setCharacterEncoding("UTF-8");
			response.setContentType("text/html;charset=utf-8");
	 ...
	 * @throws Exception
	 */
	public static void responseSuccess(HttpSession session, HttpServletResponse response, HttpServletRequest request, ModelMap modelMap, String message) {
		try {
			request.setCharacterEncoding("utf-8");
			response.setCharacterEncoding("UTF-8");
			response.setContentType("text/html;charset=utf-8");
			...
			Map<String, Object> map = new HashMap<String, Object>();
			map.put("message", message);
			map.put("success", StringConstant.TRUE);
			out.write(JSONObject.fromObject(map).toString());
			out.flush();
			out.close();
		} catch (UnsupportedEncodingException e) {
	 ...
	 * @throws Exception
	 */
	public static void responseFailed(HttpSession session, HttpServletResponse response, HttpServletRequest request, ModelMap modelMap, String message) {
		try {
			request.setCharacterEncoding("utf-8");
			response.setCharacterEncoding("UTF-8");
			response.setContentType("text/html;charset=utf-8");
			...
			Map<String, Object> map = new HashMap<String, Object>();
			map.put("message", message);
			map.put("success", StringConstant.FALSE);
			out.write(JSONObject.fromObject(map).toString());
			out.flush();
			out.close();
		} catch (UnsupportedEncodingException e) {
