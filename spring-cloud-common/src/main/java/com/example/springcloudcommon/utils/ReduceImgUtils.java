...
public class ReduceImgUtils {
    ...
    public static void main(String[] args) {
        ...
        String oldUrl = "d://2.jpg";
        String newUrl = "d://22.jpg";

        File srcfile = new File(oldUrl);
        File distfile = new File(newUrl);

        System.out.println("压缩前图片大小：" + srcfile.length());
        reduceImg(oldUrl, newUrl, 500, 500, 0.4F);
